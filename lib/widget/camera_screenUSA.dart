...
class CameraScreenUSA extends StatefulWidget {
  @override
  _CameraScreenUSAState createState() => _CameraScreenUSAState();
}

class _CameraScreenUSAState extends State<CameraScreenUSA> {
...
void _retryPermissionRequest() {
  ...
  Future<void> _pickImage(ImageSource source) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      content: Text("Permissions are required to access the camera and storage."),
            ...
            Container(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  hintText: "write text or browse with the camera icon below",
