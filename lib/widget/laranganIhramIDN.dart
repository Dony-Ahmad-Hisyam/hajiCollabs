...
class laranganIhramPage extends StatefulWidget {
  const laranganIhramPage({Key? key}) : super(key: key);

  @override
  State<laranganIhramPage> createState() => _laranganIhramPageState();
}

class _laranganIhramPageState extends State<laranganIhramPage> {
  @override
                        ...
                        RichText(
                          text: TextSpan(
                            style: TextStyle(
                              ...
                              color: Color(0xFF235092),
                              fontSize: 12, // Mengatur ukuran teks secara umum
                              shadows: [
                                Shadow(
                                  blurRadius: 2,
